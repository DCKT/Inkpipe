...
const triggerClass =
  "w-full rounded-[3px] border border-border bg-surface px-4 py-2.5 text-sm text-primary flex items-center justify-between gap-2 data-[placeholder]:text-secondary focus:border-accent focus:outline-none";

const contentClass =
  "z-50 rounded-[3px] border border-border bg-surface shadow-lg p-1";

const itemClass =
  "rounded-[2px] px-3 py-2 text-sm text-primary cursor-pointer data-[highlighted]:bg-accent-tint data-[highlighted]:text-accent-hover data-[selected]:text-accent-hover data-[selected]:font-medium";

const labelClass = "mb-1.5 block text-[11px] font-semibold uppercase tracking-[0.12em] text-accent";
