...
export default function SettingsForm({
  ...
  return (
    ...
    >
      ...
      <fieldset className="island-shell rounded-2xl p-6">
        <legend className="island-kicker mb-3 px-1">Anna's Archive</legend>
        <div className="space-y-4">
          <Field.Root>
            ...
            <Field.Input
              ...
              value={form.annasArchive.baseUrl}
              onChange={(e) =>
                setForm({
                  ...form,
                  annasArchive: { ...form.annasArchive, baseUrl: e.target.value },
                })
              }
            />
          </Field.Root>
          <Field.Root>
            ...
            <Field.Input
              type="password"
              placeholder="Your Anna's Archive member API key"
              value={form.annasArchive.apiKey}
              onChange={(e) =>
                setForm({
                  ...form,
                  annasArchive: { ...form.annasArchive, apiKey: e.target.value },
                })
              }
            />
          </Field.Root>
